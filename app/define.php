...
define('UPLOAD_HOME', ROOT_URL.'/upload');
define('FILE_HOME', ROOT_URL.'/file');
define('DEPART_HOME', ROOT_URL.'/depart');
define('MANAGER_HOME', ROOT_URL.'/manager');
define('DIRECTOR_HOME', ROOT_URL.'/director');
...
define('USER_HOME', ROOT_URL.'/user');
define('KPITABLE_HOME', ROOT_URL.'/kpitable');
define('DATA_HOME', ROOT_URL.'/data');
