...
<div id="menu">
	...
	<li class="first-child"><a href="<?php echo DEPART_HOME.'/index'?>"><span>部门管理</span></a></li>
	...
	<li class="first-child"><a href="<?php echo KPICHECK_HOME.'/depart'?>"><span>绩效考核汇总</span></a></li>
	<li><a href="<?php echo STAFFM_HOME.'/depart'?>"><span>办事员管理</span></a></li>
	<?php }?>
	
	<?php if($User->type == UserType::DEPART){?>
	<li class="first-child"><a href="<?php echo STAFF_HOME.'/index'?>"><span>办事员管理</span></a></li>
	...
	<li class="first-child"><a href="<?php echo SOURCEDATA_HOME.'/index'?>"><span>数据源数据管理</span></a></li>
	<?php }?>
