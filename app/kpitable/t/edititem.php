...
<div><select name="datasource">
	...
	<?php $HTML->selected($ds->id, $tableitem->datasource)?>><?php echo $ds->name?></option>
	<?php }?>
...
<div><select name="staff">
	...
	<?php $HTML->selected($staff->id, $tableitem->staff)?>><?php echo $staff->department?>：<?php echo $staff->name?>（<?php echo $staff->slug?>）</option>
	<?php }?>
