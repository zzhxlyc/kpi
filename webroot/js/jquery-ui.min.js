		...
		a.each(["Width", "Height"], function (h, g) {
			function i(l, o, n, k) {
				a.each(b, function () {
					...
					if (k)
						o -= parseFloat(a.curCSS(l, "margin" + this, true)) || 0
				});
				return o
			}
...
(function (a) {
	...
	a.widget("ui.mouse", {
		...
		_mouseMove : function (c) {
			if (a.browser.msie &&
				!(document.documentMode >= 9) && !c.button)
	...
	a.widget("ui.draggable", a.ui.mouse, {
		...
		_setContainment : function () {
			...
			if (d.containment == "document" || d.containment == "window")
				this.containment = [d.containment == "document" ? 0 : a(window).scrollLeft() - this.offset.relative.left - this.offset.parent.left, d.containment == "document" ? 0 : a(window).scrollTop() - this.offset.relative.top - this.offset.parent.top,
	...
	a.ui.plugin.add("draggable", "scroll", {
		...
		drag : function (d) {
			...
			if (c.scrollParent[0] != document && c.scrollParent[0].tagName != "HTML") {
				if (!e.axis || e.axis !=
					"x")
					if (c.overflowOffset.top + c.scrollParent[0].offsetHeight - d.pageY < e.scrollSensitivity)
						c.scrollParent[0].scrollTop = h = c.scrollParent[0].scrollTop + e.scrollSpeed;
					else if (d.pageY - c.overflowOffset.top < e.scrollSensitivity)
						c.scrollParent[0].scrollTop = h = c.scrollParent[0].scrollTop - e.scrollSpeed;
				if (!e.axis || e.axis != "y")
					if (c.overflowOffset.left + c.scrollParent[0].offsetWidth - d.pageX < e.scrollSensitivity)
						c.scrollParent[0].scrollLeft = h = c.scrollParent[0].scrollLeft + e.scrollSpeed;
				...
				if (!e.axis || e.axis != "x")
					if (d.pageY - a(document).scrollTop() < e.scrollSensitivity)
						h = a(document).scrollTop(a(document).scrollTop() - e.scrollSpeed);
					else if (a(window).height() - (d.pageY - a(document).scrollTop()) < e.scrollSensitivity)
						h = a(document).scrollTop(a(document).scrollTop() + e.scrollSpeed);
				if (!e.axis || e.axis != "y")
					if (d.pageX - a(document).scrollLeft() < e.scrollSensitivity)
						h = a(document).scrollLeft(a(document).scrollLeft() -
								e.scrollSpeed);
					else if (a(window).width() - (d.pageX - a(document).scrollLeft()) < e.scrollSensitivity)
						h = a(document).scrollLeft(a(document).scrollLeft() + e.scrollSpeed)
			}
			...
			for (var e = a(this).data("draggable"), h = e.options, g = h.snapTolerance, i = c.offset.left, b = i + e.helperProportions.width, f = c.offset.top, j = f + e.helperProportions.height, l = e.snapElements.length - 1; l >= 0; l--) {
				...
				if (o - g < i && i < n + g && k - g < f && f < m + g || o - g < i && i < n + g && k - g < j && j < m + g || o - g < b && b < n + g && k - g < f && f < m + g || o - g < b && b < n + g && k - g < j &&
					...
					if (!e.snapElements[l].snapping &&
						(p || q || s || r || u))
						e.options.snap.snap && e.options.snap.snap.call(e.element, d, a.extend(e._uiHash(), {
	...
	a.ui.plugin.add("resizable", "containment", {
		...
		resize : function (e) {
			...
			if (g + h.size.width >= h.parentData.width) {
				...
				if (e)
					h.size.height = h.size.width / h.aspectRatio
			}
			if (i + h.size.height >= h.parentData.height) {
				h.size.height = h.parentData.height - i;
				if (e)
					h.size.width = h.size.height * h.aspectRatio
			}
		},
		stop : function () {
			var e = a(this).data("resizable"),
				...
				this.selectees.each(function () {
					...
					if (!(!j || j.element == c.element[0])) {
						...
						if (e.tolerance == "touch")
							l = !(j.left > i || j.right < h || j.top > b || j.bottom < g);
						else if (e.tolerance == "fit")
							l = j.left > h && j.right < i && j.top > g && j.bottom < b;
						if (l) {
							if (j.selected) {
...
(function (a) {
	a.widget("ui.sortable", a.ui.mouse, {
		...
		_mouseCapture : function (d, c) {
			...
			if (a.data(d.target, "sortable-item") == h)
				e = a(d.target);
			if (!e)
				return false;
		...
		_mouseStart : function (d, c, e) {
			...
			if (!e)
				for (e = this.containers.length - 1; e >= 0; e--)
					this.containers[e]._trigger("activate", d, h._uiHash(this));
			if (a.ui.ddmanager)
				a.ui.ddmanager.current = this;
			a.ui.ddmanager && !c.dropBehaviour && a.ui.ddmanager.prepareOffsets(this, d);
			this.dragging = true;
		...
		_mouseDrag : function (d) {
			...
			if (this.options.scroll) {
				...
				if (this.scrollParent[0] != document && this.scrollParent[0].tagName != "HTML") {
					if (this.overflowOffset.top + this.scrollParent[0].offsetHeight - d.pageY < c.scrollSensitivity)
						this.scrollParent[0].scrollTop = e = this.scrollParent[0].scrollTop + c.scrollSpeed;
					...
					if (this.overflowOffset.left + this.scrollParent[0].offsetWidth - d.pageX < c.scrollSensitivity)
						this.scrollParent[0].scrollLeft = e = this.scrollParent[0].scrollLeft + c.scrollSpeed;
					...
					if (d.pageY - a(document).scrollTop() < c.scrollSensitivity)
						e = a(document).scrollTop(a(document).scrollTop() -
								c.scrollSpeed);
					else if (a(window).height() - (d.pageY - a(document).scrollTop()) < c.scrollSensitivity)
						e = a(document).scrollTop(a(document).scrollTop() + c.scrollSpeed);
					if (d.pageX - a(document).scrollLeft() < c.scrollSensitivity)
						e = a(document).scrollLeft(a(document).scrollLeft() - c.scrollSpeed);
					else if (a(window).width() - (d.pageX - a(document).scrollLeft()) < c.scrollSensitivity)
						e = a(document).scrollLeft(a(document).scrollLeft() + c.scrollSpeed)
				}
		...
		serialize : function (d) {
			...
			a(c).each(function () {
				...
				if (h)
					e.push((d.key || h[1] + "[]") + "=" + (d.key && d.expression ? h[1] : h[2]))
			});
				...
				for (d = h.length - 1; d >= 0; d--)
					for (var g = a(h[d]), i = g.length - 1; i >= 0; i--) {
						...
						if (b && b != this && !b.options.disabled)
							e.push([a.isFunction(b.options.items) ? b.options.items.call(b.element) : a(b.options.items, b.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"), b])
					}
		...
		_removeCurrentsFromItems : function () {
			for (var d = this.currentItem.find(":data(sortable-item)"), c = 0; c < this.items.length; c++)
				for (var e = 0; e < d.length; e++)
					d[e] == this.items[c].item[0] && this.items.splice(c, 1)
		},
		_refreshItems : function (d) {
			this.items = [];
			this.containers = [this];
			var c = this.items,
			e = [[a.isFunction(this.options.items) ? this.options.items.call(this.element[0], d, {
						item : this.currentItem
		...
		_setContainment : function () {
			...
			if (d.containment == "parent")
				d.containment = this.helper[0].parentNode;
			if (d.containment == "document" || d.containment == "window")
				this.containment = [0 - this.offset.relative.left - this.offset.parent.left, 0 - this.offset.relative.top - this.offset.parent.top, a(d.containment == "document" ?
...
jQuery.effects || function (a, d) {
	function c(n) {
		...
		if (n && n.constructor == Array && n.length == 3)
			return n;
		if (k = /rgb\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*\)/.exec(n))
			return [parseInt(k[1], 10), parseInt(k[2], 10), parseInt(k[3], 10)];
		if (k = /rgb\(\s*([0-9]+(?:\.[0-9]+)?)\%\s*,\s*([0-9]+(?:\.[0-9]+)?)\%\s*,\s*([0-9]+(?:\.[0-9]+)?)\%\s*\)/.exec(n))
	...
	function g(n) {
		...
		for (k in n) {
			m = n[k];
			if (m == null || a.isFunction(m) || k in o || /scrollbar/.test(k) || !/color/i.test(k) && isNaN(parseFloat(m)))
				delete n[k]
		}
		return n
	}
	...
	a.extend(a.easing, {
		...
		easeInOutElastic : function (n, k, m, p, q) {
			...
			if (r < Math.abs(p)) {
				...
				n = s / (2 * Math.PI) * Math.asin(p / r);
			if (k < 1)
				return -0.5 * r * Math.pow(2, 10 * (k -= 1)) * Math.sin((k * q - n) * 2 * Math.PI / s) + m;
	...
	a.effects.bounce = function (d) {
		return this.queue(function () {
			...
			i = d.options.distance || (j == "top" ? c.outerHeight({
					...
					3);
			if (h == "show")
				c.css("opacity", 0).css(j, g == "pos" ? -i : i);
			if (h == "hide")
				i /= b * 2;
			h != "hide" && b--;
			if (h == "show") {
...
(function (a) {
	a.effects.drop = function (d) {
		return this.queue(function () {
			...
			if (h == "show")
				c.css("opacity", 0).css(i, g == "pos" ? -b : b);
			var f = {
				opacity : h ==
				"show" ? 1 : 0
			};
	...
	a.widget("ui.menu", {
		...
		activate : function (d, c) {
			...
			if (this.hasScroll()) {
				...
				if (e < 0)
					...
					e >= g && this.element.scrollTop(h + e - g + c.height())
			}
		...
		nextPage : function (d) {
			if (this.hasScroll())
				...
				this.activate(d, this.element.children(".ui-menu-item").filter(!this.active ||
...
(function (a) {
	...
	i = function (b) {
		...
		l = a([]);
		if (f)
			l = j ? a(j).find("[name='" + f + "']") : a("[name='" + f + "']", b.ownerDocument).filter(function () {
					return !this.form
				});
		return l
	};
	a.widget("ui.button", {
		...
		_setOption : function (b, f) {
			a.Widget.prototype._setOption.apply(this, arguments);
			if (b === "disabled")
				f ? this.element.propAttr("disabled", true) : this.element.propAttr("disabled", false);
			else
				this._resetButton()
		},
		refresh : function () {
			...
			if (this.type === "input")
				...
				if (j.primary || j.secondary) {
					if (this.options.text)
						o.push("ui-button-text-icon" + (l ? "s" : j.primary ? "-primary" : "-secondary"));
...
(function (a, d) {
	function c() {
		...
		this.regional[""] = {
			closeText : "Done",
			//prevText : "Prev",//modifiedy by Lynn.
			//nextText : "Next",
			prevText : "<<",
			nextText : ">>",
			currentText : "Today",
			...
			monthNamesChinese:["一月","二月","三月","四月","五月","六月","七月","八月","九月","十月","十一月","十二月"],//modifiedy by Lynn.
			dayNames : ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"],
			dayNamesShort : ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"],
			dayNamesMin : ["Su",
				"Mo", "Tu", "We", "Th", "Fr", "Sa"],
			dayNamesChinese:["日","一","二","三","四","五","六"],//modifiedy by Lynn.
			dweekHeader : "Wk",
			dateFormat : "mm/dd/yy",
			firstDay : 0,
			isRTL : false,
		...
		this._defaults = {
			...
			changeMonth : false,
			changeYear : false,
			yearRange : "c-5:c+20", //modified by Lynn.
	...
	a.extend(c.prototype, {
		...
		_optionDatepicker : function (b, f, j) {
			...
			if (arguments.length == 2 && typeof f == "string")
				return f == "defaults" ? a.extend({}, a.datepicker._defaults) : l ? f == "all" ?
		...
		_doKeyDown : function (b) {
			...
			if (a.datepicker._datepickerShowing)
				...
				case 39:
					...
					j = b.ctrlKey || b.metaKey;
					if (b.originalEvent.altKey)
						a.datepicker._adjustDate(b.target, b.ctrlKey ? +a.datepicker._get(f, "stepBigMonths") : +a.datepicker._get(f,
								"stepMonths"), "M");
					break;
				case 40:
					if (b.ctrlKey || b.metaKey)
		...
		_findPos : function (b) {
			for (var f =
					this._get(this._getInst(b), "isRTL"); b && (b.type == "hidden" || b.nodeType != 1 || a.expr.filters.hidden(b)); )
		...
		parseDate : function (b, f, j) {
			...
			if (y < f.length)
				throw "Extra/unparsed characters found in date: " + f.substring(y);
			if (j == -1)
				j = (new Date).getFullYear();
			else if (j < 100)
				j += (new Date).getFullYear() - (new Date).getFullYear() % 100 + (j <= l ? 0 : -100);
			if (s > -1) {
				p = 1;
				q = s;
				do {
		...
		_generateHTML : function (b) {
			...
			w = this._canAdjustMonth(b, -1, v, m) ? '<a class="ui-datepicker-prev ui-corner-all" onclick="DP_jQuery_' + g + 
			".datepicker._adjustDate('#" + b.id + "', -" + p + ", 'M');\" title=\"" + 
			w + '"><span class="ui-icon ui-icon-circle-triangle-' + (j ? "e" : "w") + '">' + 
			w + "</span></a>" : o ? "" : '<a class="ui-datepicker-prev ui-corner-all ui-state-disabled" title="' + 
			w + '"><span class="ui-icon ui-icon-circle-triangle-' + (j ? "e" : "w") + '">' + w + "</span></a>";
			...
			var y = this._get(b, "dayNamesChinese"),//modified by Lynn.
			//H = this._get(b, "monthNames"),
			H = this._get(b, "monthNamesChinese"),//modified by Lynn.
			//C = this._get(b, "monthNamesShort"),
			C = this._get(b, "monthNamesChinese"),
			...
			for (var J = this._getDefaultDate(b), D = "", E = 0; E < k[0]; E++) {
				...
				for (var L = 0; L < k[1]; L++) {
					...
					for (B = 0; B < 7; B++) {
						...
						G += "<th" + ((B + n + 6) % 7 >= 5 ? ' class="ui-datepicker-week-end"' : "") + '><span>' + y[A] + "</span></th>"
					}
					F += G + "</tr></thead><tbody>";
		...
		_generateMonthYearHeader : function (b, f, j, l, o, n, k, m) {
			...
			u = "";
			//if (n || !p)
				//u += '<span class="ui-datepicker-month">' + k[f] + "</span>";
			//else {
				k = l && l.getFullYear() == j;
				...
				for (var w = 0; w < 12; w++)
					if ((!k || w >= l.getMonth()) &&
						(!v || w <= o.getMonth()))
						u += '<option value="' + w + '"' + (w == f ? ' selected="selected"' : "") + ">" + m[w] + "</option>";
				u += "</select>"
			//}
			s || (r += u + (n || !(p && q) ? "&#xa0;" : ""));
			if (!b.yearshtml) {
				b.yearshtml = "";
				//if (n || !q)
					//r += '<span class="ui-datepicker-year">' + j + "</span>";
				//else {
					...
					for (b.yearshtml += '<select class="ui-datepicker-year" onchange="DP_jQuery_' + g + ".datepicker._selectMonthYear('#" + b.id + "', this, 'Y');\" >"; f <= m; f++)
						b.yearshtml += '<option value="' + f + '"' + (f == j ? ' selected="selected"' : "") + ">" + f + "</option>";
					b.yearshtml += "</select>";
					r += b.yearshtml;
					b.yearshtml = null
				//}
	...
	a.widget("ui.dialog", {
		...
		_size : function () {
			...
			if (g.height === "auto")
				...
				this.element.height(Math.max(g.height -
						i, 0));
...
(function (a) {
	...
	a.fn.position = function (g) {
		...
		a.each(["my", "at"], function () {
			var k = (g[this] || "").split(" ");
			if (k.length === 1)
				k = d.test(k[0]) ? k.concat(["center"]) : c.test(k[0]) ? ["center"].concat(k) : ["center", "center"];
...
(function (a) {
	a.widget("ui.slider", a.ui.mouse, {
		...
		_slide : function (d, c, e) {
			...
			if (this.options.values && this.options.values.length) {
				h = this.values(c ? 0 : 1);
				if (this.options.values.length === 2 && this.options.range === true && (c === 0 && e > h || c === 1 && e < h))
					e = h;
				if (e !== this.values(c)) {
					h = this.values();
					h[c] = e;
		...
		values : function (d, c) {
			...
			if (arguments.length > 1) {
				...
				if (a.isArray(arguments[0])) {
					...
					return this.options.values && this.options.values.length ? this._values(d) :
					this.value();
			else
				return this._values()
		},
				...
				this.handles.each(function (o) {
					...
					if (e.options.range === true)
						if (e.orientation === "horizontal") {
							if (o === 0)
								e.range.stop(1, 1)[h ? "animate" : "css"]({
									left : g + "%"
								}, c.animate);
							if (o === 1)
	...
	a.widget("ui.tabs", {
		...
		_tabify : function (i) {
			...
			this.anchors.each(function (r, u) {
				...
				if (l.test(v))
					f.panels = f.panels.add(f.element.find(f._sanitizeSelector(v)));
				else if (v && v !== "#") {
			...
			for (var o; o = this.lis[i]; i++)
				a(o)[a.inArray(i, j.disabled) != -1 && !a(o).hasClass("ui-tabs-selected") ? "addClass" : "removeClass"]("ui-state-disabled");
		...
		load : function (i) {
			...
			this.abort();
			if (!l || this.element.queue("tabs").length !== 0 && a.data(j, "cache.tabs"))
